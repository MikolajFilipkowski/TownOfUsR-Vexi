...
namespace TownOfUs
{
    public static class CustomGameOptions
    {
        ...
        public static int PhantomLessTasks => (int)Generate.PhantomLessTasks.Get();
        public static int PhantomTasksRemaining => (int)Generate.PhantomTasksRemaining.Get();
        public static bool PhantomCanBeClickedBefore => Generate.PhantomCanBeClickedBefore.Get();
        public static bool PhantomCanBeClickedAfter => Generate.PhantomCanBeClickedAfter.Get();
        ...
        public static int HaunterLessTasks => (int)Generate.HaunterLessTasks.Get();
        public static int HaunterTasksRemaining => (int)Generate.HaunterTasksRemaining.Get();
        public static bool HaunterCanBeClickedBefore => Generate.HaunterCanBeClickedBefore.Get();
        public static bool HaunterCanBeClickedAfter => Generate.HaunterCanBeClickedAfter.Get();
